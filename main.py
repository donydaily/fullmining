...
os.system("clear")
print (banner)
print ("\033[1;32mWelcome To TeleBot",myself.first_name,"\n\033[1;32mBot Ini Di Gunakan Untuk Menuyul BCH Click Bot")
...
while True:
	sleep(2)
	banyaknyanuyul = 100 #ini untuk mau ambil di masing masing channel ampe berapa kali misa di BitcoinClick_bot ampe 1000 kali nuyul baru lanjut ke Zcash_click_bot atau yg lain nya 
	channel_username_list = ["@BitcoinClick_bot","@BCH_clickbot","@Dogecoin_click_bot","@Litecoin_click_bot","@Zcash_click_bot"]
	#----- BCH END -----
	for x in channel_username_list:
		try:
			sys.stdout.write("\033[1;30m# \033[1;33mNuyulin si "+x)
			channel_entity=client.get_entity(x)
			channel_username=x
			for i in range(banyaknyanuyul):
				sys.stdout.write("\r")
				sys.stdout.write("                                                              ")
				sys.stdout.write("\r")
					...
					try:
						...
						if soup.find("div",class_="g-recaptcha") is None and soup.find('div', id="headbar") is None:
							...
							for dat in soup.find_all('div',class_="container-fluid"):
								...
								sys.stdout.write("\r\033[1;30m# \033[1;32mYou earned "+js['reward']+" BCH for visiting a site!\n")
						else:
							sys.stdout.write("\r")
							sys.stdout.write("                                                                ")
							sys.stdout.write("\r")
